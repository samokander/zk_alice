...
contract PlonkVerifier {
    ...
    uint256 constant Qmx =
        5957932280068786597866691905916897048992215015920990954866831192149296555822;
    uint256 constant Qmy =
        621894286574073628718892463882435241119820017044662945042136759312326987041;
    uint256 constant Qlx =
        18719842517608583242554087543333746655726862484769568666846110822874700017384;
    uint256 constant Qly =
        16582755603195269121397483095953593811295384780449770865836354694714823683076;
    uint256 constant Qrx = 0;
    uint256 constant Qry = 0;
    uint256 constant Qox =
        5957932280068786597866691905916897048992215015920990954866831192149296555822;
    uint256 constant Qoy =
        21266348585265201593527513281374839847576491140253160717646901135332899221542;
    uint256 constant Qcx = 0;
    uint256 constant Qcy = 0;
    uint256 constant S1x =
        2920693623626642043110148658940396327034388163771887462833407775934886765046;
    uint256 constant S1y =
        8404729815466468442175196221264295392724504101713848880008579413791250108164;
    uint256 constant S2x =
        20727919604921137277994442720345343305723126675413969232504295798286372364658;
    uint256 constant S2y =
        20965660341915114752813379369846899281418040274376462877023007379927323991581;
    uint256 constant S3x =
        6795921267652106400001048790365654688620753827822469003097918015092207463147;
    uint256 constant S3y =
        13283205314377650547096095304607494895085845055395647027582729776115183909611;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 =
        13772157512954548155287510462285559816543360740063103941752213815917188069709;
    uint256 constant X2x2 =
        21693771549681482377054662864047994315469152263011210644497464595129306746160;
    uint256 constant X2y1 =
        836199803072741849840352067886643367030286066096843646147505776276068961141;
    uint256 constant X2y2 =
        20097487962894405887300967923334369449805331436103963389846224763759798611187;
